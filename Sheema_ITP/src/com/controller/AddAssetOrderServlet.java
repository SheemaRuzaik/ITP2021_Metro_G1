...
/**
 * Servlet implementation class AddAssetOrderServlet
 */
@WebServlet("/AddAssetOrderServlet")
public class AddAssetOrderServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * Default constructor.
	 */
	public AddAssetOrderServlet() {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		iinventory_asset.addOrder(order);
