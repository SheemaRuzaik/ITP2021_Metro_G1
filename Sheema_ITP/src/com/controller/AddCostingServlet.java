...
/**
 * Servlet implementation class AddCostingServlet
 */
@WebServlet("/AddCostingServlet")
public class AddCostingServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * Default constructor.
	 */
	public AddCostingServlet() {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//cost.setProfit(Float.parseFloat(request.getParameter("profit")));
		//cost.setProd_price(Float.parseFloat(request.getParameter("prod_price")));
		

		iinventory_asset.addCosting(cost);
