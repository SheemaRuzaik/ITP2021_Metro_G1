			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">Add New Inventory</h1>
							...
							<div class="col-half">
								...
								<div class="input-group input-group-icon">
									<input type="text" name="maxstock_inv" id="maxstock_inv"
										placeholder="Max Stock" required />
									<div class="input-icon">
										<i class="fa fa-lock"></i>
									</div>
								</div>
							...
							<div class="col-half">
								...
								<div class="input-group input-group-icon">
									<input type="text" name="orderqty" id="orderqty"
										placeholder="Ordering Qty" required />
									<div class="input-icon">
										<i class="fa fa-key"></i>
									</div>
								</div>
							...
							<div class="col-half">
								...
								<div class="">
									<select name="orderfrequency" id="orderfrequency"
										...
										<option value="Daily">Twice a week</option>
										<option value="Daily">Once in two weeks</option>
				...
				<div class="row">
					<div class="col-half">
						<button type="reset" class="btn btn-success" style="margin-left: 300px;">
							Cancel</button>
					</div>

					<div class="col-half">
						<button type="submit" class="btn btn-danger" id="submitbtn">Add</button>
					</div>
				</div>
