			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<table>
						...
						<%
						ArrayList<Costing> cost = new ArrayList<>();

						IInventory_Asset iinventory_asset = new Inventory_AssetImpl();

						cost = iinventory_asset.ListCosting();

						for (Costing cost_list : cost) {
						%>
						<tr>
							<td><%=cost_list.getProduct_ID()%></td>
							<td><%=cost_list.getProd_type()%></td>
							<td><%=cost_list.getFood_description()%></td>
							<td><%=cost_list.getCost_price()%></td>
							<td><%=cost_list.getProfit()%></td>
							<td><%=cost_list.getProd_price()%></td>
							<td>
								<a href="ViewProductCost"><form action="./RetrieveCostingServlet" method="post">
									<input type="hidden" name="descp" value="<%=cost_list.getFood_description()%>">
