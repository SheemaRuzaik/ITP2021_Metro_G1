			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">View Product Costing</h1>
					...
					<%
						Costing cost = (Costing) request.getAttribute("cost");
					%>

					<!-- Search Costing -->
					<form action="./RetrieveCostingServlet" method="post">
					...
					<br> <br>
					<%
						if (cost != null && cost.getFood_description() != null) {
					%>
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">
							Details of :
							<%=cost.getFood_description()%></h1>
					</div>


					<form action="./UpdateCostingServlet" method="post">
							...
							<div class="col-half">
								...
								<div class="input-group input-group-icon">
									<input type="text" name="prodid" id="prodid"
										value="<%=cost.getProduct_ID()%>" placeholder="Product ID"
										pattern="[F]+[P]+[0-9]{4}" title="FPXXXX" required />
									<div class="input-icon">
										<i class="fa fa-lock"></i>
									</div>
								</div>
						...
						<div class="row">
							<div class="col-half">
								<h4>Type:</h4>
								<select name="type" id="type" style="width: 425px;">
									<option selected><%=cost.getProd_type()%></option>
						...
						<div class="row">
							<div class="col-half">
								...
								<div class="input-group input-group-icon">
									<input type="text" name="descp" id="descp"
										value="<%=cost.getFood_description()%>"
						...
						<div class="row">
							<div class="col-half">
								<h4>Cost Price(LKR):</h4>
								<div class="input-group input-group-icon">
									<input type="number" name="costprice" id="costprice"
										value="<%=cost.getCost_price()%>" placeholder="Cost Price"
										required />
									<div class="input-icon">
										<i class="fa fa-lock"></i>
									</div>
						...
						<div class="row">
							<div class="col-half">
								<h4>Profit Added(LKR):</h4>
								<div class="input-group input-group-icon">
									<input type="number" name="profit" id="profit"
										value="<%=cost.getProfit()%>" placeholder="Profit Price"
										readonly />
									<div class="input-icon">
										<i class="fa fa-lock"></i>
									</div>
						...
						<div class="row">
							<div class="col-half">
								<h4>Product Price(LKR):</h4>
								<div class="input-group input-group-icon">
									<input type="number" name="prodprice" id="costprice"
										value="<%=cost.getProd_price()%>" placeholder="Product Price"
										readonly />
									<div class="input-icon">
										<i class="fa fa-lock"></i>
									</div>
						...
						<br> <br> <input type="hidden" name="descp"
							value="<%=cost.getFood_description()%>">
					...
					<form action="./DeleteCostingServlet" method="post">

						<input type="hidden" name="descp"
							value="<%=cost.getFood_description()%>">
