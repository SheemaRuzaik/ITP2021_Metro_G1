			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<table>
						...
						inv = iinventory_asset.ListInventory();

						for (Inventory inv_list : inv) {
						%>
						<tr>
							<td><%=inv_list.getInventoryID()%></td>
							<td><%=inv_list.getSupplierID_inv()%></td>
							<td><%=inv_list.getInventory_desc()%></td>
							<td><%=inv_list.getMaxStock_inv()%></td>
							<td><%=inv_list.getOrderQty_inv()%></td>
							<td><%=inv_list.getUnitPrice_inv()%></td>
							<td><%=inv_list.getTotalPrice()%></td>
							<td><%=inv_list.getAvailableStatus()%></td>
							<td><%=inv_list.getFrequency()%></td>
							<td><%=inv_list.getRemarks_inv()%></td>
							<td>
								<a href="ViewInventory"><form action="./RetrieveInventoryServlet" method="post">
									<input type="hidden" name="invID" value="<%=inv_list.getInventoryID()%>">
