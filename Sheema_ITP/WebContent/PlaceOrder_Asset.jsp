			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">Make New Asset Order</h1>
					...
					<!-- Content Row -->
					<form action="./AddAssetOrderServlet" method="post">
						...
						<br>
							...
							<div class="row">
								...
								<h4>Date Ordered:</h4>
									<div class="input-group input-group-icon">
										<input type="date" name="dateorderd" id="dateorderd"
