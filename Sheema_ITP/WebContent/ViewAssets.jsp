		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Search Asset -->
					<form action="./RetrieveAssetServlet" method="post">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">
							Details of Asset ID :<%=asset.getAssetID()%></h1>
					</div>
					...
					<div class="row">
						<div class="col-half">
							<h4>Supplier ID:</h4>
							<div class="input-group input-group-icon">
								<input type="text" name="supplierid" id="supplierid" value="<%=asset.getSupplierID_asst()%>"
									placeholder="Supplier ID" pattern="[S]+[0-9]{4}" title="SXXXX"
									required />
								<div class="input-icon">
									<i class="fa fa-lock"></i>
								</div>
						...
						<div class="col-half">
							<h4>Make Type:</h4>
							<div class="input-group input-group-icon">
								<input type="text" name="maketype" id="maketype" value="<%=asset.getMakeType()%>"
					...
					<div class="row">
						<div class="col-half">
							...
							<h4>Description</h4>
							<div class="input-group input-group-icon">
								<input type="text" name="descp" id="descp" value="<%=asset.getAsset_desc()%>"
						...
						<div class="col-half">
							<h4>Model:</h4>
							<div class="input-group input-group-icon">
								<input type="text" name="model" id="model" value="<%=asset.getModel()%>" placeholder="Model"
									 />
								<div class="input-icon">
									<i class="fa fa-key"></i>
								</div>
					...
					<div class="row">
						...
						<h4>Unit Price(LKR):</h4>
							<div class="input-group input-group-icon">
								<input type="number" name="unitprice" id="unitprice" value="<%=asset.getUnitAssetPrice()%>"
									placeholder="Unit Price" pattern="[0-9]{10}" title="XXXXXXXXX"
									required />
								<div class="input-icon">
						...
						<div class="col-half">
							<h4>Max Stock:</h4>
							<div class="input-group input-group-icon">
								<input type="number" name="maxstock" id="maxstock" value="<%=asset.getMaxStock()%>"
									placeholder="Max Stock" pattern="[0-9]{10}" title="XXXXXXXXX"
									required />
								<div class="input-icon">
									<i class="fa fa-home"></i>
								</div>
					...
					<div class="row">
						<div class="col-half">
							<h4>Remarks:</h4>
							<div class="input-group input-group-icon">
								<input type="text" name="remarks" id="remarks" value="<%=asset.getRemarks()%>"
									placeholder="Remarks" />
								<div class="input-icon">
					...
					<form action="./DeleteAssetServlet" method="post">
