			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">Add Product Costing</h1>
					...
					<form action="./AddCostingServlet" method="post">
						...
						<div class="row">
							<div class="col-half">
								...
								<input type="text" name="prodid" id="prodid"
										placeholder="Product ID" pattern="[F]+[P]+[0-9]{4}"
										title="FPXXXX" required />
