            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="GetExpense.jsp">View Expense</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">View Expense Details</h1>           
                    </div>
				    ...
				    <form action="./UpdateExpense" method="post">
						      ...
						      <div class="">
						          	<select name="category" id="category" style="width: 413px;" required>
										<option selected><%=expense.getCategory()%></option>
										...
										<option value="Employee Salary Payment">Employee Salary Payment</option>																		
						      ...
						      <div class="input-group input-group-icon">
						        <input type="date" name="date" id="date" value="<%=expense.getDate()%>" required/>
						      ...
						      <h4>Amount</h4>
						      <div class="input-group input-group-icon">
						        <input type="text" name="amount" id="amount" value="<%=expense.getAmount()%>" required/>
						     ...
						     <button type="submit" class="cancel" id="btn-remove">Delete Expense</button>
			               	</form>
