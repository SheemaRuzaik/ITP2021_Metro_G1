        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h2 style="text-align: center;">Welcome Promotion Manager</h2>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                <%=promotion.getU_name() %></div>
                                                
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Discount Rs.<%=promotion.getR_price() %> ->To Rs. <%=promotion.getD_price() %></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-clipboard-list fa-2x text-gray-300">Promo Code:<%=promotion.getCode() %></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
