			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">Generate Report for Supplier Orders Placed</h1>
                	...
                	<form action="./GenerateReport" method="post">
					 		...
					 		<div class="row">
								...
								<div class="input-group input-group-icon">
			 						<input type="text" id="supp_ID" name="supp_ID" placeholder="Supplier ID"  pattern="[S]+[0-9]{4}" title="SXXXX" required />
			 						<div class="input-icon"><i class="fa fa-calendar"></i></div>
			 					</div>
			 					</div>
			 					</div>
					 				
					 		<button type="submit" class="btn btn-success" style="height: 50px; width: 180px;"> Print Details</button>
...
<!--                     <h1 class="h3 mb-0 text-gray-800">Monthly Salary Transaction Details</h1> -->
<!--                 </div> -->
                
                
<!--                 Monthly Salary Report -->
                
<!--                 	<form action="./MonthlySalaryTransaction" method="post"> -->
				 		
<!-- 					 		<div class="row"> -->
<!-- 								<div class="col-half"> -->
<!-- 								<h4>Select Month</h4> -->
<!-- 								<div class="input-group input-group-icon"> -->
<!-- 			 						<input type="month" id="month" name="month" placeholder="mm-yyyy" required> -->
<!-- 			 						<div class="input-icon"><i class="fa fa-calendar"></i></div> -->
<!-- 			 					</div> -->
<!-- 			 					</div> -->
<!-- 			 					</div> -->
