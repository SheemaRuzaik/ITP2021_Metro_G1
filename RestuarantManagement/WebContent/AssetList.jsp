			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<table>
						...
						asset = iinventory_asset.ListAsset();

						for (Asset asset_list : asset) {
						%>
						<tr>
							<td><%=asset_list.getAssetID()%></td>
							<td><%=asset_list.getSupplierID_asst()%></td>
							<td><%=asset_list.getAsset_desc()%></td>
							<td><%=asset_list.getMakeType()%></td>
							<td><%=asset_list.getModel()%></td>
							<td><%=asset_list.getMaxStock()%></td>
							<td><%=asset_list.getUnitAssetPrice()%></td>
							<td><%=asset_list.getRemarks()%></td>
							<td>
								<a href="ViewAssets"><form action="./RetrieveAssetServlet" method="post">
									<input type="hidden" name="assetID" value="<%=asset_list.getAssetID()%>">
