        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Finance List</h1>
                    <a href="SaveFinance.jsp"><button class="btn btn-success" style="margin-left: 500px; height: 50px; width: 180px;">Save Finance</button></a>
                </div>
                ...
                <!-- Table Start -->
                	...
                	<table>
                    		...
                    		<%
	        					...
	        					ArrayList<Notification> sum = new ArrayList<>();
	        					IPayroll ip = new PayrollImpl();
	        					sum = ip.notificationList();
	        					for(Notification notif : sum){
                    		%>
                    		<tr>
                    			<td><%=notif.getNotificationID() %></td>
								<td><%=notif.getMonth() %></td>
								<td><%=notif.getAmount() %></td>
								<td><%=notif.getDescription() %></td>
								<td><%=notif.getDate() %></td>
								<td>
									<form action="./DeleteNotification" method="post">
											<input type="hidden" name="delete" id="delete" value="<%=notif.getNotificationID()%>">
											<button type="submit" class="btn btn-danger" id="delete" style="height: 35px; width: 100px; margin: 5px;">Delete</button>
										</form>
								</td>
                    		</tr>
