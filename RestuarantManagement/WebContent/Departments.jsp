            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <% 	Employee empl = new Employee();
                       		...
                       		empl = ipayroll1.manager("User & Payroll Management");
                      	%>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><%=empl.getFullname() %></span>
                ...
                <table>
					...
					<tr>
						...
						emp1 = ipayroll.manager("Inventory & Assert Management");
						%>
						<td>2</td>
						<td><%=emp1.getDepartment() %></td>
						<td><%=emp1.getEmpid() %></td>
						<td><%=emp1.getFullname() %></td>
						<td>InventoryAdmin</td>
						<td>123456</td>
					</tr>
					...
					<tr>
						...
						emp2 = ipayroll.manager("Customer Management");
						%>
						<td>2</td>
						<td><%=emp2.getDepartment() %></td>
						<td><%=emp2.getEmpid() %></td>
						<td><%=emp2.getFullname() %></td>
						<td>CustomerAdmin</td>
						<td>123456</td>
					</tr>
					...
					<tr>
						...
						emp3 = ipayroll.manager("POS & Transaction Management");
						%>
						<td>2</td>
						<td><%=emp3.getDepartment() %></td>
						<td><%=emp3.getEmpid() %></td>
						<td><%=emp3.getFullname() %></td>
						<td>TransactionAdmin</td>
						<td>123456</td>
					</tr>
					...
					<tr>
						...
						emp4 = ipayroll.manager("Supplier Management");
						%>
						<td>2</td>
						<td><%=emp4.getDepartment() %></td>
						<td><%=emp4.getEmpid() %></td>
						<td><%=emp4.getFullname() %></td>
						<td>SupplierAdmin</td>
						<td>123456</td>
					</tr>
					...
					<tr>
						...
						emp5 = ipayroll.manager("Promotions Management");
						%>
						<td>2</td>
						<td><%=emp5.getDepartment() %></td>
						<td><%=emp5.getEmpid() %></td>
						<td><%=emp5.getFullname() %></td>
						<td>PromotionAdmin</td>
						<td>123456</td>
					</tr>
