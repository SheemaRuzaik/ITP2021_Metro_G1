            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Promotion Report</h1>
                    ...
                    <br><br>
                    <div class="col">
                    <form action="promoReport" method="post" >
                    <div class="row">
						    <div class="col-half">
						    <h4>Year</h4>
						        <div class="">
						          	<select name="year" id="year" style="width: 425px;" required>
						    ...
						    <h4>Month</h4>
						        <div class="">
						          	<select name="month" id="month" style="width: 425px;" required>
		            ...
		            <thead>
		            <tr>
		                <th class="tableTh">Promotion Code</th>
						...
						ArrayList<PromoReport> arrayList1 = promo.getReport((String)session.getAttribute("promoYear").toString(),(String)session.getAttribute("promoMonth").toString());
						
						for (PromoReport promos : arrayList1) {
							
					%><tr>
						<td class="tableTh"><%=promos.getCode() %></td>
						<td class="tableTh"><%=promos.getUname() %></td>
						<td class="tableTh"><%=promos.getCount() %></td>
					  </tr>
					<%
						}
					%>
		            <tbody>
                        ...
                        <form action="promoGen" method="get" >
						    ...
						    <div class="row">
						      ...
						      <div class="col-half">
						      	<button type="submit" class="btn btn-danger" id="submitbtn" style="width: 150px; height: 50px;"> Report </button>
						      </div>
						      </div>
						      </div>
