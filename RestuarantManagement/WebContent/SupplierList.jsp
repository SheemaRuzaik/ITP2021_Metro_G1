			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<table>
						...
						supp = iinventory_asset.ListSupplier();

						for (Supplier supp_list : supp) {
						%>
						<tr>
							<td><%=supp_list.getSupplier_ID()%></td>
							<td><%=supp_list.getSupplier_name()%></td>
							<td><%=supp_list.getItem_type()%></td>
