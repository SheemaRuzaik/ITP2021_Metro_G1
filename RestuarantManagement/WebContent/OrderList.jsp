<%@page import="com.service.Inventory_AssetImpl"%>
<%@page import="com.service.IInventory_Asset"%>
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">Supplier Orders Placed</h1>
					...
					<table>
						...
						order = iinventory_asset.ListAssetOrder();

						for (AssetOrder order_list : order) {
						%>
						<tr>
							<td><%=order_list.getSupp_orderID()%></td>
							<td><%=order_list.getSupplierID()%></td>
							<td><%=order_list.getAssetID()%></td>
							<td><%=order_list.getOrderAssetQty()%></td>
							<td><%=order_list.getTotalAssetPrice()%></td>
							<td><%=order_list.getDateOrdered()%></td>
							
							<td>
								<a href="ViewAssetOrder"><form action="./RetrieveAssetOrderServlet" method="post">
									<input type="hidden" name="orderID" value="<%=order_list.getSupp_orderID()%>">
									<button type="submit" class="btn btn-warning"
										style="height: 35px; width: 80px; margin: 5px;">View</button>
								</form></a>
