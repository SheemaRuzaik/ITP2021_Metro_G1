            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="Incomes.jsp">Incomes</a>                     
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Incomes List</h1>                      
                    </div>
                    ...
                    <!-- Content Row -->
                         ...
                         <table>              
                             ...
                             %>     
                             <tr>
                                 <td><%=ps.getPosPayId()%></td>
                                 <td><%=ps.getCategory()%></td>
                                 <td><%=ps.getDate()%></td>
                                 <td><%=ps.getMethod()%></td>
                                 <td><%=ps.getCardType()%></td>
                                 <td><%=ps.getCardNo()%></td>
                                 <td><%=ps.getCardHoldName()%></td>
                                 <td><%=ps.getTotAmount()%></td>
                                 <td>
                                     <form action="GetPOS" method="post">
                                         <input type="hidden" name="posPayId" id="posPayId" value="<%=ps.getPosPayId()%>">
